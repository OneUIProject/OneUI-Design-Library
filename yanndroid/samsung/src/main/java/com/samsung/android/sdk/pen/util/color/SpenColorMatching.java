...
public class SpenColorMatching {
    ...
    public boolean matchColor(float[] fArr, float[] fArr2) {
        ...
        Log.i(TAG, "matchColor() index=" + matchedColorIndex + " IN[" + fArr[0] + ", " + fArr[1] + ", " + fArr[2] + "] -> OUT[" + fArr2[0] + ", " + fArr2[1] + ", " + fArr2[2] + "]");
        return true;
    }
    ...
    public int getMatchedColorIndex(float[] fArr) {
        ...
        Log.i(TAG, "setColor() Not matchedIndex=" + matchHsvColor);
        return -1;
    }
