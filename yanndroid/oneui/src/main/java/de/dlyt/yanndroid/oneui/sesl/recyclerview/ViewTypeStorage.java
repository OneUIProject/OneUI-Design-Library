...
interface ViewTypeStorage {
    ...
    @NonNull
    ViewTypeLookup createViewTypeWrapper(@NonNull NestedAdapterWrapper wrapper);
    ...
    class SharedIdRangeViewTypeStorage implements ViewTypeStorage {
        ...
        public NestedAdapterWrapper getWrapperForGlobalType(int globalViewType) {
            List<NestedAdapterWrapper> nestedAdapterWrappers = mGlobalTypeToWrapper.get(globalViewType);
        ...
        class WrapperViewTypeLookup implements ViewTypeLookup {
            ...
            public int localToGlobal(int localType) {
                List<NestedAdapterWrapper> wrappers = mGlobalTypeToWrapper.get(localType);
                if (wrappers == null) {
    ...
    class IsolatedViewTypeStorage implements ViewTypeStorage {
        ...
        @Override
        public NestedAdapterWrapper getWrapperForGlobalType(int globalViewType) {
            NestedAdapterWrapper wrapper = mGlobalTypeToWrapper.get(globalViewType);
            if (wrapper == null) {
                throw new IllegalArgumentException("Cannot find the wrapper for global view type " + globalViewType);
            }
            return wrapper;
        ...
        class WrapperViewTypeLookup implements ViewTypeLookup {
            ...
            public int globalToLocal(int globalType) {
                ...
                if (index < 0) {
                    throw new IllegalStateException("requested global type " + globalType + " does not belong to the adapter:" + mWrapper.adapter);
                }
