...
public class SamsungAlertDialog extends AppCompatDialog implements DialogInterface {
    ...
    protected SamsungAlertDialog(@NonNull Context context, @StyleRes int themeResId) {
        super(context, resolveDialogTheme(context, themeResId));
        mAlert = new SamsungAlertController(getContext(), this, getWindow());
    }

    protected SamsungAlertDialog(@NonNull Context context, boolean cancelable, @Nullable OnCancelListener cancelListener) {
        this(context, 0);
    ...
    public static class Builder {
        ...
        @NonNull
        public SamsungAlertDialog create() {
            // We can't use Dialog's 3-arg constructor with the createThemeContextWrapper param,
            // so we always have to re-set the theme
            final SamsungAlertDialog dialog = new SamsungAlertDialog(P.mContext, mTheme);
        ...
        public SamsungAlertDialog show() {
            final SamsungAlertDialog dialog = create();
            dialog.show();
            return dialog;
        }
    }
