...
import de.dlyt.yanndroid.oneui.coordinatorlayout.ABLBehavior;
import de.dlyt.yanndroid.oneui.coordinatorlayout.SamsungCoordinatorLayout;

@SamsungCoordinatorLayout.DefaultBehavior(SamsungAppBarLayout.Behavior.class)
public class SamsungAppBarLayout extends LinearLayout implements ABLBehavior {
    ...
    protected static class BaseBehavior<T extends SamsungAppBarLayout> extends HeaderBehavior<T> {
        ...
        public final void animateOffsetWithDuration(final SamsungCoordinatorLayout var1, final T var2, int var3, int var4) {
        ...
        public final boolean canScrollChildren(SamsungCoordinatorLayout var1, T var2, View var3) {
            boolean var4;
        ...
        public boolean onLayoutChild(SamsungCoordinatorLayout var1, T var2, int var3) {
        ...
        public boolean onNestedPreFling(SamsungCoordinatorLayout var1, T var2, View var3, float var4, float var5) {
            this.mVelocity = var5;
            if (var5 < -300.0F) {
        ...
        public void onNestedPreScroll(SamsungCoordinatorLayout var1, T var2, View var3, int var4, int var5, int[] var6, int var7) {
            if (var5 != 0) {
                int var8;
                if (var5 < 0) {
        ...
        @SuppressLint("WrongConstant")
        public void onNestedScroll(SamsungCoordinatorLayout var1, T var2, View var3, int var4, int var5, int var6, int var7, int var8) {
        ...
        public Parcelable onSaveInstanceState(SamsungCoordinatorLayout var1, T var2) {
        ...
        public boolean onStartNestedScroll(SamsungCoordinatorLayout var1, T var2, View var3, View var4, int var5, int var6) {
            boolean var7;
        ...
        public void onStopNestedScroll(SamsungCoordinatorLayout var1, T var2, View var3, int var4) {
        ...
        public int setHeaderTopBottomOffset(SamsungCoordinatorLayout var1, T var2, int var3, int var4, int var5) {
        ...
        public final boolean shouldJumpElevationState(SamsungCoordinatorLayout var1, T var2) {
        ...
        public final void snapToChildIfNeeded(SamsungCoordinatorLayout var1, T var2) {
    ...
    public static class ScrollingViewBehavior extends HeaderScrollingViewBehavior {
        ...
        public boolean onDependentViewChanged(SamsungCoordinatorLayout var1, View var2, View var3) {
            this.offsetChildAsNeeded(var2, var3);
            this.updateLiftedStateIfNeeded(var2, var3);
            return false;
        }

        public boolean onRequestChildRectangleOnScreen(SamsungCoordinatorLayout var1, View var2, Rect var3, boolean var4) {
