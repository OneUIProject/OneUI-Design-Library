...
public class SamsungTabLayout extends HorizontalScrollView {
    ...
    public SamsungTabLayout(Context var1) {
        this(var1, (AttributeSet)null);
    }

    public SamsungTabLayout(Context var1, AttributeSet var2) {
        this(var1, var2, R.attr.tabStyle);
    }

    @SuppressLint({"RestrictedApi", "WrongConstant"})
    public SamsungTabLayout(Context var1, AttributeSet var2, int var3) {
        ...
        if (this.scrollAnimator == null) {
            ...
            this.scrollAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
                public void onAnimationUpdate(ValueAnimator var1) {
                    SamsungTabLayout.this.scrollTo((Integer)var1.getAnimatedValue(), 0);
                }
            });
        }
    ...
    private class AdapterChangeListener implements SeslViewPager.OnAdapterChangeListener {
        ...
        public void onAdapterChanged(SeslViewPager var1, PagerAdapter var2, PagerAdapter var3) {
            SamsungTabLayout var4 = SamsungTabLayout.this;
    ...
    private class PagerAdapterObserver extends DataSetObserver {
        ...
        public void onChanged() {
            SamsungTabLayout.this.populateFromPagerAdapter();
        }
    ...
    private class SlidingTabIndicator extends LinearLayout {
        ...
        public void onMeasure(int var1, int var2) {
            ...
            if (MeasureSpec.getMode(var1) == 1073741824) {
                SamsungTabLayout var3 = SamsungTabLayout.this;
    ...
    public static class Tab {
        ...
        public SamsungTabLayout parent;
        ...
        public boolean isSelected() {
            SamsungTabLayout var1 = this.parent;
            if (var1 != null) {
                boolean var2;
        ...
        public Tab setIcon(Drawable var1) {
            this.icon = var1;
            SamsungTabLayout var2 = this.parent;
    ...
    public static class TabLayoutOnPageChangeListener implements SeslViewPager.OnPageChangeListener {
        ...
        public final WeakReference<SamsungTabLayout> tabLayoutRef;

        public TabLayoutOnPageChangeListener(SamsungTabLayout var1) {
        ...
        public void onPageScrolled(int var1, float var2, int var3) {
            SamsungTabLayout var4 = (SamsungTabLayout)this.tabLayoutRef.get();
            if (var4 != null) {
        ...
        public void onPageSelected(int var1) {
            SamsungTabLayout var2 = (SamsungTabLayout)this.tabLayoutRef.get();
    ...
    public final class TabView extends LinearLayout {
        ...
        public TabView(Context var2) {
            ...
            this.setGravity(17);
            this.setOrientation(SamsungTabLayout.this.inlineLabel ? HORIZONTAL : VERTICAL);
            ...
            if (SamsungTabLayout.this.mDepthStyle == 1) {
                ViewCompat.setPaddingRelative(this, 0, SamsungTabLayout.this.tabPaddingTop, 0, SamsungTabLayout.this.tabPaddingBottom);
            }
        ...
        public void onLayout(boolean var1, int var2, int var3, int var4, int var5) {
            ...
            if (this.iconView != null && this.tab.icon != null) {
                ...
                if (var9 != null && this.mIndicatorView != null && this.mTextParentView != null) {
                    ...
                    var2 = var3;
                    if (SamsungTabLayout.this.mIconTextGap != -1) {
                        var2 = var3 + SamsungTabLayout.this.mIconTextGap;
                    }
        ...
        public void onMeasure(int var1, int var2) {
            ...
            int var5 = SamsungTabLayout.this.getTabMaxWidth();
            int var6;
            if (SamsungTabLayout.this.mRequestedTabWidth != -1) {
                var6 = MeasureSpec.makeMeasureSpec(SamsungTabLayout.this.mRequestedTabWidth, 1073741824);
            } else {
                var6 = var1;
                if (var5 > 0) {
                    label80: {
                        ...
                        var6 = MeasureSpec.makeMeasureSpec(SamsungTabLayout.this.tabMaxWidth, -2147483648);
                    }
                }
            }
            ...
            if (var7 != null && this.customView == null) {
                SamsungTabLayout var8 = SamsungTabLayout.this;
                ...
                if (var15 != null && var15.getVisibility() == 0) {
                    ...
                    if (var7 != null) {
                        ...
                        if (var7.getLineCount() > 1) {
                            var10 = SamsungTabLayout.this.tabTextMultiLineSize;
                            var1 = var4;
                        }
                    }
                }
                ...
                if (var12 != 0 || var4 >= 0 && var1 != var4) {
                    boolean var14 = var13;
                    if (SamsungTabLayout.this.mode == 1) {
                        var14 = var13;
                        if (var12 > 0) {
                            var14 = var13;
                            if (var11 == 1) {
                    ...
                    if (var14) {
                        ...
                        SamsungTabLayout.this.checkMaxFontScale(this.textView, (int)var10);
            ...
            if (this.customTextView == null && this.mTextParentView != null && this.textView != null && this.tab != null) {
                SamsungTabLayout var17 = SamsungTabLayout.this;
        ...
        public final void showMainTabTouchBackground(int var1) {
            if (this.mMainTabTouchBackground != null && SamsungTabLayout.this.mDepthStyle == 1 && SamsungTabLayout.this.tabBackgroundResId == 0) {
        ...
        public final boolean startTabTouchAnimation(MotionEvent var1, KeyEvent var2) {
            if (var1 != null && this.tab.getCustomView() == null && this.textView != null && (var1 != null || var2 != null) && (var1 == null || var2 == null)) {
                ...
                TextView var4;
                SamsungTabLayout var5;
                AbsIndicatorView var6;
                Tab var7;
                SamsungTabLayout var8;
                if (var3 != 0) {
                    if (var3 != 1) {
                        if (var3 == 3) {
                            this.textView.setTypeface(SamsungTabLayout.this.mNormalTypeface);
                            var5 = SamsungTabLayout.this;
                            ...
                            if (var7 != null) {
                                ...
                                if (var4 != null) {
                                    var4.setTypeface(SamsungTabLayout.this.mBoldTypeface);
                                    var8 = SamsungTabLayout.this;
                    ...
                    label73: {
                        this.mIsCallPerformClick = false;
                        if (this.tab.position != SamsungTabLayout.this.getSelectedTabPosition()) {
                            TextView var9 = this.textView;
                            if (var9 != null) {
                                var9.setTypeface(SamsungTabLayout.this.mBoldTypeface);
                                var5 = SamsungTabLayout.this;
                                ...
                                if (var7 != null) {
                                    var4 = var7.view.textView;
                                    if (var4 != null) {
                                        var4.setTypeface(SamsungTabLayout.this.mNormalTypeface);
                                        var8 = SamsungTabLayout.this;
            ...
            if (this.customView == null) {
                if (this.textView == null) {
                    ...
                    if (SamsungTabLayout.this.mDepthStyle == 2) {
                        ...
                        if (SamsungTabLayout.this.mode != 0) {
                            i2 = -1;
                        }
                        i = SamsungTabLayout.this.mSubTabIndicatorHeight;
                        this.mIndicatorView = (AbsIndicatorView) relativeLayout2.findViewById(R.id.indicator);
                        if (!(this.mIndicatorView == null || SamsungTabLayout.this.mSubTabSelectedIndicatorColor == -1)) {
                            this.mIndicatorView.setSelectedIndicatorColor(SamsungTabLayout.this.mSubTabSelectedIndicatorColor);
                        }
                    } else {
                        ...
                        if (AbsIndicatorView != null) {
                            AbsIndicatorView.setSelectedIndicatorColor(SamsungTabLayout.this.mTabSelectedIndicatorColor);
                        }
                ...
                if (drawable != null) {
                    DrawableCompat.setTintList(drawable, SamsungTabLayout.this.tabIconTint);
                    PorterDuff.Mode mode = SamsungTabLayout.this.tabIconTintMode;
                    if (mode != null) {
                        DrawableCompat.setTintMode(drawable, mode);
                    }
                }
                TextViewCompat.setTextAppearance(this.textView, SamsungTabLayout.this.tabTextAppearance);
                SamsungTabLayout tabLayout = SamsungTabLayout.this;
                tabLayout.checkMaxFontScale(this.textView, (int) tabLayout.tabTextSize);
                ColorStateList colorStateList = SamsungTabLayout.this.tabTextColors;
        ...
        public final void updateBackgroundDrawable(Context var1) {
            SamsungTabLayout var2 = SamsungTabLayout.this;
            if (var2.tabBackgroundResId != 0 && var2.mDepthStyle != 2) {
                this.baseBackgroundDrawable = AppCompatResources.getDrawable(var1, SamsungTabLayout.this.tabBackgroundResId);
        ...
        public final void updateTextAndIcon(TextView var1, ImageView var2) {
            ...
            if (var2 != null) {
                ...
                if (var5 && var2.getVisibility() == 0) {
                    if (SamsungTabLayout.this.mIconTextGap != -1) {
                        var6 = SamsungTabLayout.this.mIconTextGap;
                    } else {
